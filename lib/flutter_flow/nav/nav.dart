...
class AppStateNotifier extends ChangeNotifier {
  TaistyFirebaseUser? initialUser;
  TaistyFirebaseUser? user;
  ...
  void update(TaistyFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ...
                  : MealsWidget(
                      hg: params.getParam('hg', ParamType.String),
                    ),
            ),
            FFRoute(
              name: 'MealsCopy',
            ...
            FFRoute(
              ...
              path: 'ingredients',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Ingredients')
                  : IngredientsWidget(),
            ),
            FFRoute(
              name: 'MealsCopy2',
            ...
            FFRoute(
              name: 'meal_info',
              path: 'mealInfo',
              builder: (context, params) => MealInfoWidget(
                mealRef: params.getParam(
                    'mealRef', ParamType.DocumentReference, false, 'temp'),
              ),
            ),
            FFRoute(
              name: 'login',
